...
export const adminLinks: AdminLink[] = [
  ...
  { href: '/admin/users', label: 'Personnel', icon: '/ICONS/USER SETTINGS.svg' },
  { href: '/admin/xp', label: 'Level System', icon: '/ICONS/XP.svg' },
        ...
        >
          <div style={{ position: 'relative', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', minHeight: '70px', overflow: 'hidden' }}>
            <Link href="/" className={styles.sidebarLogo}>
              <img src="/brand/logo.png" alt="BHL Logo" style={{ height: '32px', objectFit: 'contain' }} />
              <motion.span
                initial={false}
                animate={{ 
