                ...
                <div className={styles.divCardTop}>
                  ...
                  <div>
                    ...
                    <div className={styles.memberCount}>
                      {divisionCounts[div.id] !== undefined ? divisionCounts[div.id] : div.members} members
                    </div>
                  </div>
                </div>
                  ...
                  <div className={styles.divLeader}>
                    ...
                    <div className={styles.leaderRow}>
                      <div className="avatar" style={{ width: '32px', height: '32px' }}>
                        {leaders[div.id].avatar ? <img src={leaders[div.id].avatar} alt="" /> : leaders[div.id].username[0]}
                      </div>
